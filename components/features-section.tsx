            ...
            >
              <CardHeader className="p-5 pb-3">
                <div className="w-10 h-10 bg-green-100 dark:bg-emerald-900/50 rounded-lg flex items-center justify-center mb-3">
                  <feature.icon className="h-5 w-5 text-green-600 dark:text-emerald-400" />
                </div>
                <CardTitle className="text-base md:text-lg text-gray-900 dark:text-white font-bold">{feature.title}</CardTitle>
              </CardHeader>
              <CardContent className="p-5 pt-0">
                <p className="text-xs md:text-sm text-gray-600 dark:text-gray-300 leading-relaxed">{feature.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
